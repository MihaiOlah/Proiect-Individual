...
public class Virus2 : MonoBehaviour
{
    ...
    private string MinDistance()        // nume referinta pentru ca vrem sa salvam coord gasite
    {
        ...
        if (distErik < distBaleog && distErik < distOlaf)   // cautam distanta minima si returnam numele vikingului, pentru a indica care va fi urmarit de virus
        {
            return "Erik";
        }
