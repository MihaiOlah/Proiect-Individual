...
// scriptul ne permite sa aruncam itemele din inventarul lui Baleog
public class SlotBaleog : MonoBehaviour
{
    ...
    void Start()
    {
        inventory = GameObject.FindGameObjectWithTag("Baleog").GetComponent<Inventory>();
    }
    ...
    public void DropObject()
    {
        ...
        {
            child.GetComponent<ItemSpawn>().SpawnRemovedItem("Baleog", GameObject.FindGameObjectWithTag("Baleog").transform.localScale.x);       // apelam metoda de drop cu tag-ul Erik pentru itemul sters
